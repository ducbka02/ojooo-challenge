...
export const Tooltip: any = ({
      ...
      (
        ...
        isMounted.current &&
          setDimensions({
            xOffset: pageOffsetX,
            yOffset:
              Platform.OS === 'ios' || skipAndroidStatusBar
                ? pageOffsetY
                : pageOffsetY -
                  Platform.select({
  ...
  }, [getElementPosition, onClose, toggleOnPress, visible])
  ...
  const tooltipStyle = React.useMemo(
    ...
    [containerStyle, dimensions, height, width, withPointer],
  )
  ...
  return (
    <View collapsable={false} ref={renderedElement}>
      ...
      <ModalComponent transparent visible={visible}>
        <TouchableOpacity
          style={{
